...
\hldef{(mles} \hlkwb{<-} \hlkwd{optim}\hldef{(}\hlkwc{par} \hldef{=} \hlkwd{c}\hldef{(}\hlnum{1}\hldef{,}\hlnum{1}\hldef{),}    \hlcom{##how do I know what to guess here?}
         \hlkwc{fn} \hldef{= llgamma,}
         \hlkwc{data}\hldef{=dat.wind}\hlopt{$}\hldef{speed,}      \hlcom{#### WHAT DATA SHOULD I PUT IN????}
         \hlkwc{neg}\hldef{=T))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'dat.wind' not found}}\begin{alltt}
\hldef{alpha.hat.mle} \hlkwb{<-} \hldef{mles}\hlopt{$}\hldef{par[}\hlnum{1}\hldef{]}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'mles' not found}}\begin{alltt}
\hldef{beta.hat.mle} \hlkwb{<-} \hldef{mles}\hlopt{$}\hldef{par[}\hlnum{2}\hldef{]}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'mles' not found}}\end{kframe}
\end{knitrout}
    \item Compute the MLEs for these data using the Log-Normal distribution.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{ll_lognorm} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{data}\hldef{,} \hlkwc{par}\hldef{,} \hlkwc{neg}\hldef{=F)\{}
  \hldef{mu} \hlkwb{<-} \hldef{par[}\hlnum{1}\hldef{]}
  \hldef{sigma} \hlkwb{<-} \hldef{par[}\hlnum{2}\hldef{]}

  \hldef{loglik} \hlkwb{<-} \hlkwd{sum}\hldef{(}\hlkwd{dlnorm}\hldef{(}\hlkwc{x}\hldef{=data,} \hlkwc{meanlog}\hldef{=mu,} \hlkwc{sdlog}\hldef{=sigma,} \hlkwc{log}\hldef{=}\hlnum{TRUE}\hldef{))}

  \hlkwd{return}\hldef{(}\hlkwd{ifelse}\hldef{(neg,} \hlopt{-}\hldef{loglik, loglik))}
  \hldef{\}}

\hldef{(mles} \hlkwb{<-} \hlkwd{optim}\hldef{(}\hlkwc{par} \hldef{=} \hlkwd{c}\hldef{(}\hlnum{0}\hldef{,}\hlnum{1}\hldef{),}  \hlcom{##how do I know what to guess here?}
               \hlkwc{fn} \hldef{= ll_lognorm,}
               \hlkwc{data} \hldef{= dat.wind}\hlopt{$}\hldef{speed,}  \hlcom{#### WHAT DATA SHOULD I PUT IN????}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'dat.wind' not found}}\begin{alltt}
\hldef{mu.hat.mle} \hlkwb{<-} \hldef{mles}\hlopt{$}\hldef{par[}\hlnum{1}\hldef{]}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'mles' not found}}\begin{alltt}
\hldef{sigma.hat.mle} \hlkwb{<-} \hldef{mles}\hlopt{$}\hldef{par[}\hlnum{2}\hldef{]}
\end{alltt}
